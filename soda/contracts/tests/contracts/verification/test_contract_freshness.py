...
def test_contract_freshness_pass(test_warehouse: TestWarehouse, environ: dict):
    table_name: str = test_warehouse.ensure_test_table(contracts_freshness_test_table)
...
def test_contract_freshness_fail(test_warehouse: TestWarehouse, environ: dict):
    table_name: str = test_warehouse.ensure_test_table(contracts_freshness_test_table)
